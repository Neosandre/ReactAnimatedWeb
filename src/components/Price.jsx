...
const packages = [
    ...
    description:"A common form of Lorem ipsum reads: Lorem ipsum dolor sit amet, consectetur adipiscing elit.",green:`${rectangle}`},
       ...
       <div className='mt-16'>
          <label htmlFor='toggle' className='inline-flex items-center cursor-pointer'>
                ...
                <div className='w-14 h-6 bg-gray-300 rounded-full transition duration-200 ease-in-out'>
                    <div className={`w-6 h-6 rounded-full ${isYearly ? "bg-primary ml-8":"bg-gray-500"} `}>
      ...
      className='grid sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-20 md:w-11/12 mx-auto'>
        {
            ...
            <ul className='mt-4 space-y-2 px-4'>
                ...
                <li className='flex gap-3 items-center'><img src={pkg.green} alt='' className='w-4 h-4' />  Additional practical tasks</li>
